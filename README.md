#  Payam Resan Ruby SMS API Examples

نمونه کدهای آماده Ruby برای اتصال به **وب‌سرویس پیامکی پیام‌رسان**  
...
در این ریپازیتوری، **نمونه‌کدهای Ruby برای استفاده از متدهای مختلف وب‌سرویس پیام‌رسان** قرار داده شده است. اگر توسعه‌دهنده Ruby هستید، می‌توانید به راحتی با این کدها، سامانه پیام‌رسان را به برنامه خود متصل کنید.
